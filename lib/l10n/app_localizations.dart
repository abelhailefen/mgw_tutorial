...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Could not fully determine device info. Proceeding with available data.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'No launchable content for: {itemName}'**
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['am', 'en', 'or', 'ti'].contains(locale.languageCode);
