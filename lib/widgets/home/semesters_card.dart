...
class SemestersCard extends StatelessWidget {
  ...
  void _handleEnrollAction(BuildContext context) {
    ...
    if (authProvider.currentUser != null) {
      // Go to payment method selection screen (middle screen)
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (_) => PaymentMethodScreen(semester: semester),
        ),
      );
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    String displayImageUrl = semester.firstImageUrl ??
        'https://via.placeholder.com/600x300.png?text=Semester+Image';
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Chip(
                  label: Text('$displayPrice ${l10n.currencySymbol}',
                      style: theme.chipTheme.labelStyle?.copyWith(fontSize: 14)),
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(l10n.enrollNowButton,
                      style: TextStyle(
