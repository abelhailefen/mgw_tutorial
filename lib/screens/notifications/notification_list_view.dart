...
import 'package:timeago/timeago.dart' as timeago; // timeago package is available
...
class _NotificationListViewState extends State<NotificationListView> {
  ...
  Widget _buildVideoWithPlayIcon(String? mediaUrl, int blogId) {
    final videoUrl = "https://usersservicefx.amtprinting19.com/${mediaUrl ?? ''}";
        ...
        _videoControllers[blogId] = VideoPlayerController.network(videoUrl)
          ..initialize().then((_) {
            ...
            print("Error initializing video for blog $blogId: $error");
             ...
             if (mounted) setState(() {}); // Trigger rebuild to show error/placeholder
          });
     }
       ...
       return Container(
          ...
          child: const Center(
             child: CircularProgressIndicator.adaptive(
                 valueColor: AlwaysStoppedAnimation<Color>(Colors.white54)), // White indicator over dark
          ),
        );
    }
                  ...
                  onTap: () {
                     ...
                     Navigator.push(
                       ...
                       MaterialPageRoute(
                         ...
                         builder: (context) => BlogDetailsScreen(blog: notification),
                       ),
                     );
                  },
                  borderRadius: BorderRadius.circular(12.0),
                    ...
                    children: [
                      ...
                      if (notification.media != null)
                        ClipRRect(
                          ...
                          child: isVideo
                              ? _buildVideoWithPlayIcon(notification.media, notification.id)
                              : Image.network(
                                  "https://usersservicefx.amtprinting19.com/${notification.media}",
                                  height: 180, // Fixed height for list items
                                  width: double.infinity,
                                  fit: BoxFit.cover,
                                  errorBuilder: (context, error, stackTrace) {
                                    print("Error loading image for blog ${notification.id}: $error");
                                    return Container(
                                        height: 180,
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Row( // Notification type and time
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(
                                     notification.notificationType, // Display the type
                                   ...
                                   Text(
                                    timeago.format(DateTime.parse(notification.createdAt)), // timeago.format is available
